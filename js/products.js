  ...
  products: [
    {
      ...
      label: "기본형",
      tagline: "비업무 사이트 차단",
      short: "조직 정책에 따라 비업무·유해 사이트 접속을 통제하는 기본형 제품입니다.",
      summary:
      ...
      targets: "인터넷 사용 통제와 내부 정보보호가 필요한 조직",
    },
    {
      id: "officeguard-sv",
      name: "OfficeGuard SV",
      label: "가시성 강화",
      tagline: "SSL/TLS 스마트 가시성",
      short: "암호화 트래픽 환경에서 보안 사각지대를 줄이는 SSL 가시성 제품입니다.",
      summary:
      ...
      targets: "SSL 트래픽 비중이 높은 기관과 보안 연동이 필요한 환경",
    },
    {
      id: "officeguard-plus",
      ...
      label: "통합형",
      tagline: "SSL + 콘텐츠 차단",
      short: "접속 통제와 SSL 가시성을 하나로 묶은 통합형 웹 보안 제품입니다.",
      summary:
      ...
      targets: "SSL 가시성과 콘텐츠 차단을 동시에 요구하는 조직",
    },
  ],
  companyInfo: {
    name: "플랜티넷",
